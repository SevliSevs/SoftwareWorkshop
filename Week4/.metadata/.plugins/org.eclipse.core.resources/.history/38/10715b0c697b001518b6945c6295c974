...
public class Population
{
	...
	private double deathRate; //death rate for the population
	private ArrayList<Person> deaths; //people who die in update method
	/**
	...
	*/
	public Population(int popsize, double initial, double infect, double recover)
	{
		...
		this.deaths = new ArrayList<Person>();
	...
	*/
	public void update()
	{
		for(int i = 0; i < getPopsize(); i++)
		{
			//System.out.println("Popsize: " + getPopsize());
			//System.out.println("Infected: " + howManyInfected());
			if(isInfected(i))
			{
